const Golang = () => {
  return (
    <svg className="min-w-full min-h-full" viewBox="0 0 128 128">
      <defs>
...
const Bash = () => {
  return (
    <svg className="min-w-full min-h-full" viewBox="0 0 128 128">
      <path fill="#f2f2f2" d="M4.24 4.24h119.53v119.53H4.24z"></path>
      <path
        fill="#2D3D45"
...
export { JavaScript, Python, TypeScript, Java, Golang, Bash, Rust };

...
export function CountriesBar({ days }: { days: number }) {
          ...
          <div style={{ height: `${height}px` }} className="w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={chartData} layout="vertical" margin={{ top: 0, right: 30, left: 0, bottom: 0 }}>
                ...
                <YAxis dataKey="country" type="category" width={80} fontSize={12} className="fill-muted-foreground" tickLine={false} axisLine={false} />
                <Tooltip

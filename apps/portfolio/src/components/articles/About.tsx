...
import hpic from "../../../public/p.png";

export default function About() {
  const svgSize = "w-[45px] h-[45px] max-md:w-[40px] max-md:h-[40px]";
  return (
    <>
      <section className="bg-neutral-600/30 text-gray-800 dark:text-gray-100 py-20 px-20 max-sm:px-4 flex gap-20 justify-center items-start max-lg:items-center leading-relaxed text-lg max-lg:flex-col-reverse">
        <div className="w-1/2 max-lg:w-full max-sm:text-[17px] max-sm:leading-[1.7]">
          <h1 className="text-4xl max-sm:text-3xl font-bold mb-6">Who I Am</h1>
          <p className="mb-6">
            I&apos;m <span className="font-semibold">Tabsir</span>, a full-stack
            developer based in Bangladesh, passionate about building dynamic web
            frontends and robust backend systems. You can call me
            <span className="font-semibold"> CG</span>—whether it stands for
            <span className="font-bold"> CatGuy</span> or
            <span className="font-bold"> Computer Guy</span>, both fit me well!
          </p>
          ...
          <p className="mb-6">
            While I work across the full stack, my passion lies in backend
            development. Especially working with
            <span className="font-semibold"> APIs, data</span>, and
            <span className="font-semibold"> Algorithms</span>.
          </p>
          <p className="mb-6">
            There&apos;s something satisfying about seeing how APIs interact
            with each other, databases, how they manipulate data, and how
            everything comes together. I enjoy building:
          </p>

          <ul className="list-disc pl-5 mb-6">
            <li>Dashboards and visualizations</li>
            <li>Microservices</li>
            <li>Complex platforms like e-commerce and social media apps</li>
          </ul>
          <p className="mb-6">
            Anything involving relational platforms and systems grabs my
            attention!
          </p>
          ...
          <p className="mb-6">
            When I&apos;m not working (which is most of the time), Probably I am
            reading a book or learning about AI or refining some of my skills. I
            also enjoy spending time with my cat and occasionally catching up
            with friends, though work remains my primary focus.
          </p>
          <h2 className="text-3xl max-sm:text-2xl font-bold mb-4">
            Let&apos;s Connect
          </h2>
          <p>
            ...
            <span className="font-semibold"> Tech, Data, or AI </span>—or
            working on something exciting—I&apos;d love to connect!
          </p>
        </div>

        <div className="w-1/3 flex flex-col  gap-16 max-sm:w-full">
          <div className="rounded-full border-2 border-gray-500 w-80 h-80 overflow-hidden">
            <Image
              src={hpic}
              alt="profile pic"
              width={400}
          ...
          <div className="flex gap-5 flex-col justify-center w-fit max-sm:hidden bg-neutral-900/60 px-16 py-3 items-center rounded-lg border border-slate-700">
            <h2 className="text-xl"> Primary Techs </h2>

            <div className="flex gap-4">
              <svg viewBox="0 0 128 128" className={svgSize}>
                <title>ReactJS</title>
                <g fill="#61DAFB">
              ...
              <svg id="nextJS" viewBox="0 0 128 128" className={svgSize}>
                <title>NextJS</title>

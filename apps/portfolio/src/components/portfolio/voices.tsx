  ...
  return (
    ...
    >
      ...
      <div className="page-shell">
        <header className="grid grid-cols-[0.9fr_1fr] items-end gap-20 mb-16 max-xl:grid-cols-1 max-xl:gap-7">
          <h2
            className={cn(
        ...
        <div className="flex items-center flex-wrap gap-3.5 mt-[18px] font-mono text-xs tracking-widest uppercase text-muted max-xl:gap-2.5">
          ...
          <span className="flex-1 max-xl:hidden"></span>
        ...
        <blockquote className="mt-14 grid grid-cols-[auto_1fr] gap-x-6 items-start max-w-[900px] max-xl:grid-cols-1">
          ...
          <p
            className={cn(
              "font-serif italic text-[clamp(22px,2.2vw,32px)] leading-[1.32] tracking-tight text-cream text-balance",
              "[&_em]:not-italic [&_em]:font-mono [&_em]:text-[0.55em] [&_em]:tracking-widest [&_em]:uppercase [&_em]:text-accent [&_em]:bg-accent/8 [&_em]:px-2 [&_em]:py-0.5 [&_em]:rounded-xs [&_em]:align-[0.18em] [&_em]:mr-1.5",
            )}
          >
